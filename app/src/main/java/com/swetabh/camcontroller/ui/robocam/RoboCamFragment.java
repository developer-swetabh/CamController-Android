...
public class RoboCamFragment extends android.support.v4.app.Fragment
        implements View.OnClickListener, MainContract.RoboCamViewContract {
    ...
    * */
    ...
    public static RoboCamFragment newInstance() {
        return new RoboCamFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_robo_cam, container, false);
    }
    ...
    private File createImageFile() {
        ...
        String imageFileName = "RoboCam_" + timeStamp + "_";
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                if (FD.length > 0) {
                    ...
                    for (int faceDetection : FD) {
                        fdList.add(faceDetection);
                        Log.d(TAG, "setUpCameraOutputs: FD type:" + Integer.toString(faceDetection));
                    }
                    if (maxFD > 0) {
    ...
    /**
     * Opens the camera specified by {@link RoboCamFragment#mCameraId}.
     */
    ...
    private void setFaceDetect(CaptureRequest.Builder requestBuilder, Integer faceDetectMode) {
